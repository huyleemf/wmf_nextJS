  ...
  return (
    <div className="about-us">
      ...
      <div className="row">
        ...
        >
          <img alt="" src={"/static/images/weekly-training-video.png"} />
          {props.data.cfg_content &&
            props.data.cfg_content.includes("youtube.com") && (
      ...
      <div className="about-us-content">
        <div className="container" style={{ pointerEvents: "none" }}>
          <h1 className="contact-header" style={{ pointerEvents: "none" }}>
            {isEmpty(props.site)
              ? `${props.data.cfg_title + " " + "At We Make Footballers"}`
              : `${props.data.cfg_title + " At " + props.site.ms_name}`}
          </h1>
        </div>
