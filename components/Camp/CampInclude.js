    ...
    <div className="training-include">
      {props.data && (
        <div className="container">
              ...
              <div key={index}>
                <div className="slide-item">
                  <div className="slide-image">
                    <img alt="" src={Utils.getThumb(element.image)} />
                  </div>
          ...
          <div
            className={width > 767 ? "slide-control" : "slide-control mobile"}
          >
            <button
              onClick={() => {
                      ...
                      return (
                        <Fragment key={index}>
                          <div style={styles.paging}>
                            <button style={styles.pagingActive}>
                              {index + 1}
                            </button>
                          </div>
                          {index < slideItem.length - 1 && <Dot />}
                        </Fragment>
                      );
                    else
                      return (
