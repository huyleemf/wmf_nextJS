              ...
              <div className="row">
                {lstImage && lstImage.length > 0 && (
                  <div className="item mt-285">
                    <img alt="" src={Utils.getThumb(lstImage[0].image, "c1")} />
                  </div>
                )}
                {lstImage && lstImage.length > 1 && (
                  <div className="item mt-285">
                    <img alt="" src={Utils.getThumb(lstImage[1].image, "c1")} />
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-6">
                  {lstImage && lstImage.length > 2 && (
                    <img
                      alt=""
                      src={Utils.getThumb(lstImage[2].image, "c2")}
                      className="mb-30"
                    />
                  )}
                  {lstImage && lstImage.length > 3 && (
                    <img alt="" src={Utils.getThumb(lstImage[3].image, "c2")} />
                  )}
                </div>
                <div className="col-6">
                  {lstImage && lstImage.length > 4 && (
                    <img alt="" src={Utils.getThumb(lstImage[4].image, "c1")} />
                  )}
                </div>
              </div>
              <div className="full-width mt-30 hiden-mobile">
                {lstImage && lstImage.length > 5 && (
                  <img alt="" src={Utils.getThumb(lstImage[5].image, "c3")} />
                )}
              </div>
            </div>
          </div>
