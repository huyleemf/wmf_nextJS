      ...
      <div className="head-top-mobile">
        <div className="container">
          <Link href={PathRoute.Home}>
            <img src="/static/images/logo.svg" className="logo" alt="" />
          </Link>
          <button
            ...
            <ul className="menu">
                ...
                <Link
                  ...
                  href={`${
                    !isEmpty(defaultAcademy)
                      ? "/" + defaultAcademy.ms_alias + PathRoute.WeeklyTraining
              ...
              <li className="menu-link">
                <Link
                  href={`${
                    !isEmpty(defaultAcademy)
                      ? "/" + defaultAcademy.ms_alias + PathRoute.HolidayCamp
              ...
              <li className="menu-link">
                <Link
                  href={`${
                    !isEmpty(defaultAcademy)
                      ? "/" + defaultAcademy.ms_alias + PathRoute.OneTraining
              ...
              <li className="menu-link">
                <Link
                  href={`${
                    !isEmpty(defaultAcademy)
                      ? "/" + defaultAcademy.ms_alias + PathRoute.BirthdayParty
              ...
              <li>
                <a
                  ...
                  onClick={(evt) => {
                    ...
                    router.push(PathRoute.BookTrialTraining);
                  }}
                >
                  Book a{" "}
        ...
        <div className="menu-down">
          <div className="container">
            ...
            <ul className="menu-small">
              {defaultAcademy && (
                <li className="menu-link" style={{ marginLeft: 0 }}>
                  <Link
