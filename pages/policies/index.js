      ...
      <div className="about-us" style={{ backgroundColor: "white" }}>
        ...
        >
          <div className="container">
            <h1 className="contact-header" style={{ maxWidth: "50%" }}>
              {data.cfg_title}
            </h1>
          </div>
          <div className="container">
        ...
        <div className="container our-policies">
          ...
          <p className="text-1">Select a card to view our company policies</p>
        </div>
                ...
                data.cfg_value.map((item, index) => (
                  ...
                  >
                    <div className="item">
                      ...
                      <Link
                        href={`${PathRoute.Policy}/${snakeCase(item.title)}`}
                        passHref
                      >
