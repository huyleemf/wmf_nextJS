...
function BookTrialTraining() {
  ...
  const checkAndScrollBtnSubmit = () => {
    setTimeout(() => {
      const btnSubmitNextStep = document.querySelector("#btn-submit-step");
                    ...
                    <div>
                      {lstCourse.map((item, index) => (
                        ...
                        >
                          <Radiobox
                            onChange={() => {
                              dispatch(courseStartDate(item.course_id));
                              setCourseSelected(item);
                            }}
                            checked={
                              item.course_id === courseSelected.course_id
                            }
                          >
                            {item.day_of_week}
                          </Radiobox>
                ...
                >
                  <div className="">
                    ...
                    <Select
                      ...
                      isSearchable={false}
                      isMulti={false}
                      getOptionLabel={(option) => option.date_show}
                ...
                <BorderButton
                  ...
                  onClick={() => {
                    if (validateData()) {
                      ...
                      _dataStep1.company_id = siteSelected.pa_companyId;
                      _dataStep1.course_id = courseSelected.course_id;
              ...
              {activeTab === 3 && (
                <BookTrialTraining3
                  ...
                  findAcademy={() => {
                    setFindAcademy(true);
                    setLstCourse([]);
                    dispatch(findNearByAcademy(currentLat, currentLng));
                  }}
                  bookOther={() => {
                    dispatch(
                      bookCourse({
