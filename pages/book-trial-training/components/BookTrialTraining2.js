...
function BookTrialTraining2(props) {
  ...
  return (
    <div className="tab-2">
      <h2>
        Just a few more details about your child before we get them booked
      </h2>
      ...
      <div style={{ marginTop: "3rem" }}>
        <div className="wSelect2">
          ...
          <input
            ...
            onChange={(event) => {
              global.bookTraining.child_first_name = event.target.value;
        ...
        <div className="wSelect2">
          ...
          <input
            ...
            placeholder="Example name"
            onChange={(event) => {
              global.bookTraining.child_last_name = event.target.value;
        ...
        <div className="wSelect2">
          ...
          <input
            ...
            className="inputText"
            onChange={(event) => {
              global.bookTraining.medical_info = event.target.value;
        ...
        <div className="wSelect2">
          ...
          <input
            ...
            placeholder="Example name"
            onChange={(event) => {
              global.bookTraining.person_emergency = event.target.value;
      ...
      <div className="wSelect2">
        ...
        <div style={{ paddingTop: "1rem" }}>
          {verifyPass2 ? <IconVerify /> : <IconUnVerify />} One lowercase
          character
        </div>
        <div style={{ paddingTop: "1rem" }}>
          {verifyPass3 ? <IconVerify /> : <IconUnVerify />} One uppercase
          character
        </div>
        <div style={{ paddingTop: "1rem" }}>
          {verifyPass4 ? <IconVerify /> : <IconUnVerify />} One number, symbol,
          ...
          <div style={{ backgroundColor: "white", padding: "2rem" }}>
            ...
            <div className="wSelect2">
              ...
              >
                Total: &nbsp; £
                {Math.round(
                  (10 * props.dataStep1.courseSelected.course_price) /
                    props.dataStep1.courseSelected.course_length
                ) / 10}
              </p>
            </div>
          </div>
      ...
      <p style={{ fontSize: 24 }}>
        By clicking below we will setup your account in our booking software,
        Parent Area.
      </p>
      {props.showLogin && (
