      ...
      <li>
        <button
          ...
          onClick={() => {
            ...
            if (validateInput() && props.onSendData) props.onSendData(_data);
          }}
        >
          Enquire Now
        </button>
  ...
  return (
    <div className="book_your_child_free_session" id="booking">
      <div className="container">
        <h2 className="heading">Enquire more about our holiday camps</h2>
        <div className="text-sub">
          Want to learn more about our Holiday camps? Get in touch via the form
          below and we will respond within 24 hours.
        </div>
              ...
              <Fragment>
                <li>
                  <label className="label">
                    ...
                    <a
                      ...
                      onClick={(evt) => {
                        ...
                        setShowSelect(false);
                        setLocation("Loading...");
                        Utils.getCurrentAcademy(dispatch, 3);
                      }}
                      className="location"
                    >
                  ...
                  <div ref={ref} className="custom-select">
                    ...
                    >
                      {isEmpty(location) ? "Select Academy" : location}
                    </div>
                    <div
