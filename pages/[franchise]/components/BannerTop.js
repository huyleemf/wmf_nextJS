    ...
    >
      <div className="container">
        ...
        <div className="box-text">
          <p>
            Learn football the right way with the UK’s #1 weekly training
            programs & holiday camps
          </p>
          <a
            href="/#"
            className="btn-book"
        ...
        <div className="academy-info">
              ...
              {options.length > 1 ? (
                <div>
                  ...
                  <p className="appendix">
                    *{props.site && props.site.ms_name} has {options.length}{" "}
                    different locations. Choose your preference here
                  </p>
                </div>
              ) : (
                <p style={{ margin: "8px 16px" }}>{options[0].label}</p>
              )}
          ...
          <div className="group-info">
            ...
            <div style={{ paddingTop: "6px" }}>
              <a className="text-express-enquiry" href={PathRoute.Contact}>
                Make an enquiry
              </a>
              <div>
                <p className="text-express">
                  ...
                  <a
                    className="phone"
                    href={`tel:${props.site ? props.site.ms_phone : ""}`}
                  >
              ...
              <div>
                <a href={fbLink} target="_blank" rel="noreferrer">
                  <img alt="" src={"static/images/icon-fb-small.png"} />
                </a>
