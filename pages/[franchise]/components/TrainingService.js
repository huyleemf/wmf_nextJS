        ...
        {props.options.length > 1 ? (
          <div>
            ...
            <p className="appendix">
              *{props.site && props.site.ms_name} has {props.options.length}{" "}
              different locations. Choose your preference here
            </p>
          </div>
        ) : (
          <p style={{ margin: "8px 16px" }}>{props.options[0].label}</p>
        )}
      </div>
      <p
      ...
      {lstCourse &&
        lstCourse.map((item, index) => (
          ...
          >
            ...
            <p>
              {moment(item.course_day_time_start, "hh:mm:ss").format("h:mma")}-
              {moment(item.course_day_time_end, "hh:mm:ss").format("h:mma")}
            </p>
            <p>
...
function LDHolidayCamp(props) {
  ...
  return (
    <>
      ...
      ></p>
      <h5>Upcoming camps by {props.site ? props.site.ms_name : ""} Academy:</h5>
      {lstCourse.map((item, index) => (
        <Fragment key={index}>
          {/* <div
                        className="classRow"
      ...
      {!props.isMobile && (
        <Fragment>
          ...
          {Utils.isEmpty(courseSelected) ? (
            <div>
              See more at{" "}
              <a style={{ color: "#ef9042" }} href={PathRoute.HolidayCamp}>
                Holiday Camps
              </a>
            </div>
          ) : (
    ...
    return (
      !_.isEmpty(list) && (
        <div className="service-mobile">
          <h2>
            {props.site ? props.site.ms_name : ""} junior football training
            services:
          </h2>
          <div>
      ...
      <div className="box-reasons training-service">
        <div className="container">
          ...
          <div className="content-small">
              ...
              {!_.isEmpty(list) &&
                list.map((item, index) => (
                  <li
                    ...
                    style={{
                      borderBottomColor:
                        activeIndex - 1 === index || hoverIndex - 1 === index
                          ? "#ef9042"
                          : "",
                    }}
            ...
            >
              <div
                className={`tab-pane ${activeIndex === 0 ? "active" : ""}`}
                id={1}
              >
                <LDWeeklyTraining
                  site={props.site}
              ...
              <div
                className={`tab-pane ${activeIndex === 1 ? "active" : ""}`}
                id={2}
              >
                <LDHolidayCamp
                  site={props.site}
              ...
              <div
                className={`tab-pane ${activeIndex === 2 ? "active" : ""}`}
                id={3}
              >
                <LDOneTraining
                  config={
              ...
              <div
                className={`tab-pane ${activeIndex === 3 ? "active" : ""}`}
                id={4}
              >
                <LDBirthdayParty
                  config={
              ...
              <div
                className={`tab-pane ${activeIndex === 4 ? "active" : ""}`}
                id={5}
              >
                <LDSchoolTraining
                  config={
