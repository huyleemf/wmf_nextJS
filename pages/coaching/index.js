...
import { sendForm } from "redux/actions/sendFormAction";
              ...
              <div className="container coaching">
                <div className="tab-1">
                  ...
                  <div className="wSelect2">
                    ...
                    />
                    <label className="input-error">{errors.email}</label>
                  </div>
                  <div className="wSelect2">
                    ...
                    />
                    <label className="input-error">{errors.telephone}</label>
                  </div>
                  ...
                  <div className="wSelect2">
                    ...
                    />
                    <label className="input-error">{errors.dbs}</label>
                    ...
                    {ARRAY.map((item) => {
                      ...
                      return (
                        <div
                          ...
                          onClick={() => {
                            if (values.dbs?.value != "Yes") return;
                            if (isChecked) {
                              const arr = qualifications.filter(
                                (el) => el !== item.label
                              );

                              setFieldValue("qualifications", arr);
                            } else {
                              const arr = [...qualifications, item.label];
                              setFieldValue("qualifications", arr);
                            }
                          }}
                        >
                          {isChecked ? <IconVerify /> : <IconUnVerify />}
                          &nbsp;&nbsp;
                          {item.label}
                        </div>
                      );
