...
import ContactMap from "components/include/ContactMap";
        ...
        >
          <div className="container">
            <h1 className="contact-header">
              ...
              {!_.isEmpty(academy) ? academy?.ms_name + " " : " WMF"} Academy
            </h1>
            <div className="get-in-touch" action="">
              <ul className="list-form">
                ...
                <li>
                  <label className="label">THE NATURE OF YOUR ENQUIRY</label>
                  <Select
                    options={OPTION}
                    isSearchable={false}
                    isMulti={false}
                  ...
                  />
                  <label className="input-error">{natureError}</label>
                </li>
                <li>
                  ...
                  ></textarea>
                  <label className="input-error">{messageError}</label>
                </li>
                <li>
                  <Captcha />
                </li>
                <li>
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (validation() && response && response.length > 0) {
                        const defaultAcademy = academy || {};
                        let _totalData = {
                          type: "contact",
                          academyEmail: defaultAcademy.ms_email,
                          academyPhone: defaultAcademy.ms_phone,
                          academyName: defaultAcademy.ms_name,
                          name: name,
                          phone: phone,
                          email: email,
                          message: message,
                ...
                >
                  For more information about our privacy practices, please read
                  our
                  <a
                    style={{
                      color: "#FF7531",
